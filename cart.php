...
<head>
    ...
    <title>SERENE TRADERS - Cart Details</title>
...
<div class="container">
    ...
    <table class="table-bodered text-center">
                  ...
                  <tr>
                      ...
                      <?php 
                        ...
                        if (isset($_POST['update_cart'])) {
                          ...
                          $update_cart = "update `cart_details` set quantity = $quantities where ip_address = '$get_ip_adress'";
